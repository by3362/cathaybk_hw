                ...
                try:
                    ...
                    while times2 < 3:
                        try:
                            ...
                            if tel_src[0].img and tel_src != "":
                                tel_src = tel_src[0].img["src"].strip()
                                res = requests.get(url="http:" + tel_src + ".jpg", headers=headers, verify = False, allow_redirects=False, timeout = (10,15))
                            ...
                            times2 += 1
                            print("Requests Timeout Error, link : http:", tel_src, ".jpg, 重試第", times2, "次")
                            await asyncio.sleep(int(random.uniform(1, 3)))
                        except requests.exceptions.SSLError:
                            times2 += 1
                            print("Requests SSL Error, link : http:", tel_src, ".jpg, 重試第", times2, "次")
                            await asyncio.sleep(int(random.uniform(1, 3)))
                        except requests.exceptions.ReadTimeout:
                            times2 += 1
                            print("Requests Read Timeout Error, link : http:", tel_src, ".jpg, 重試第", times2, "次")
                            await asyncio.sleep(int(random.uniform(1, 3)))
                        except requests.exceptions.ConnectionError as e:
                            times2 += 1
                            print(e, ", link : http:", tel_src, ".jpg, 重試第", times2, "次")
                            await asyncio.sleep(int(random.uniform(5, 8)))
                        except ssl.SSLError:
                            times2 += 1
                            print("SSL Error, link : http:", tel_src, ".jpg, 重試第", times2, "次")
                            await asyncio.sleep(int(random.uniform(1, 3)))
                        except urllib3.exceptions.ProtocolError:
                            times2 += 1
                            print("urlib3 Protocol Error, link : http:", tel_src, ".jpg, 重試第", times2, "次")
                            await asyncio.sleep(int(random.uniform(1, 3)))
                        except AttributeError as e:
                            times2 += 1
